...
class DatePickerCustomTemplate extends React.Component {
...
DatePickerCustomTemplate.propTypes = {
...
function datepicker(locals) {
  ...
  return (
    <View ref="dateMainView" style={formGroupStyle}>
      {label}
      <DatePickerCustomTemplate locals={locals} />
      {help}
      {error}
    </View>
  );
